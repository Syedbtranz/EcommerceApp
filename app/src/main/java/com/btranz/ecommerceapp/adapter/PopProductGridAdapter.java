 ...
 */
public class PopProductGridAdapter extends BaseAdapter {
    ...
    public PopProductGridAdapter(FragmentActivity context, ArrayList<ProductModel> objects) {
//        Resource = resource;
        modelList = objects;
...
//        ImageLoader.getInstance().init(ImageLoaderConfiguration.createDefault(context));
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = inflater.inflate(R.layout.gallary_inflate, parent, false);
